...
//!
//! `orrery_games::Skirmish` is the ruleset: kinematic movement over `libm`
//! and integer combat with cooldowns and reach. The factory is the shape the
//! header documents (`crates/orrery_sim_host/include/orrery_sim_host.h:9-15`);
