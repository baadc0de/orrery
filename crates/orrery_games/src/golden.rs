...
/// Regolith, by scenario name. Generated with the command above at ruleset v8.
pub const REGOLITH: [(&str, [u8; 32]); 4] = [
    (
        "solo",
        [
            0xbe, 0x11, 0xbe, 0x7a, 0xf0, 0x28, 0x62, 0xc3, 0xeb, 0xdf, 0xf4, 0x71, 0x07, 0x6b,
            0x84, 0xe5, 0x6b, 0x8d, 0xce, 0xa8, 0xda, 0xe2, 0x7e, 0xd7, 0x8f, 0x9c, 0x05, 0x49,
            0x30, 0xfc, 0xdd, 0xa3,
        ],
    ),
    (
        "duel",
        [
            0x3e, 0xf9, 0xc3, 0xdf, 0xc2, 0x85, 0x13, 0x51, 0xe5, 0x4e, 0xa3, 0x63, 0x2a, 0x7d,
            0x5e, 0x7e, 0x1e, 0x6e, 0x7a, 0x89, 0x30, 0xf1, 0x32, 0xda, 0x52, 0xec, 0x99, 0x72,
            0x86, 0x0b, 0xd3, 0xbc,
        ],
    ),
    (
        "island",
        [
            0x00, 0xc1, 0x41, 0x46, 0xc3, 0x44, 0xc6, 0x85, 0xb4, 0xb9, 0x5f, 0x5c, 0x44, 0xd8,
            0x93, 0xfd, 0x29, 0x98, 0x95, 0x29, 0xca, 0x12, 0xa4, 0xd9, 0xa8, 0x7f, 0xa1, 0x68,
            0x98, 0x0c, 0xa6, 0xb5,
        ],
    ),
    (
        "island-lossy",
        [
            0xed, 0xef, 0xa8, 0x21, 0x77, 0x56, 0x4f, 0xa8, 0xda, 0x36, 0xf2, 0x17, 0xf0, 0x2a,
            0x76, 0x44, 0x38, 0x31, 0xdb, 0x15, 0x98, 0x24, 0xc6, 0x22, 0x70, 0x4d, 0x48, 0x92,
            0x22, 0x38, 0xd1, 0x4c,
        ],
    ),
];
...
pub const REGOLITH_PICKUP_CONTEST: [[u8; 32]; 3] = [
    [
        0x5b, 0x8e, 0xb3, 0x9b, 0x05, 0x3b, 0x2b, 0x67, 0xa8, 0x80, 0x0c, 0xc4, 0x1b, 0x18, 0xe1,
        0x7d, 0xb4, 0xc1, 0x09, 0x4f, 0x83, 0xe4, 0x10, 0x56, 0x3a, 0xfe, 0x2e, 0x18, 0xe0, 0xf7,
        0x92, 0x84,
    ],
    [
        0x68, 0x0f, 0x1b, 0x70, 0xb0, 0x6a, 0x19, 0x79, 0x94, 0x3a, 0xe3, 0xf8, 0x56, 0xb2, 0x7d,
        0x70, 0x10, 0x10, 0x73, 0xed, 0x7c, 0xdb, 0x57, 0x32, 0xd4, 0x9a, 0x93, 0x3b, 0x6c, 0x11,
        0x6d, 0x8f,
    ],
    [
