...
/// Regolith, by scenario name. Generated with the command above at ruleset v6.
pub const REGOLITH: [(&str, [u8; 32]); 4] = [
    (
        "solo",
        [
            0x49, 0x5c, 0xbb, 0x88, 0x90, 0x51, 0x2a, 0xc0, 0x82, 0x8e, 0xd7, 0x65, 0x20, 0xb5,
            0x0b, 0x63, 0x87, 0xec, 0x7e, 0x97, 0x3f, 0x7d, 0x46, 0x91, 0x4e, 0x5c, 0xb4, 0x11,
            0xcd, 0xfb, 0xae, 0xab,
        ],
    ),
    (
        "duel",
        [
            0x34, 0xe1, 0x27, 0x8d, 0xde, 0x3a, 0x9a, 0x2b, 0x06, 0xad, 0xf3, 0x07, 0x92, 0x83,
            0x5d, 0xb1, 0xf5, 0xdb, 0xec, 0x65, 0xb3, 0x25, 0xf3, 0x6c, 0x90, 0x6f, 0x19, 0xee,
            0xf7, 0xab, 0xd8, 0xdb,
        ],
    ),
    (
        "island",
        [
            0x85, 0x77, 0xbe, 0x8b, 0xe2, 0xef, 0x44, 0x54, 0xd9, 0xe5, 0x0b, 0xe3, 0x20, 0xb3,
            0xf3, 0x4b, 0x0e, 0x94, 0x66, 0xf3, 0x65, 0xaf, 0x67, 0x94, 0x1a, 0x50, 0xb2, 0x61,
            0xfb, 0xdb, 0xeb, 0x73,
        ],
    ),
    (
        "island-lossy",
        [
            0x26, 0x5c, 0x96, 0x75, 0xf0, 0xc9, 0x9c, 0x25, 0xb9, 0xe9, 0xd7, 0x8e, 0x5e, 0x6f,
            0xa7, 0x47, 0xd0, 0xf4, 0x05, 0x7d, 0x20, 0x7e, 0x8a, 0xb5, 0x83, 0xd5, 0x80, 0x76,
            0xae, 0x09, 0x18, 0x94,
        ],
    ),
];
