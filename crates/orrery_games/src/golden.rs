...
/// Regolith, by scenario name. Generated with the command above at ruleset v9.
pub const REGOLITH: [(&str, [u8; 32]); 4] = [
    ...
    (
        "duel",
        [
            0x1a, 0x50, 0xac, 0xc2, 0x6e, 0x3a, 0xbd, 0x3c, 0x67, 0x99, 0x21, 0x13, 0xec, 0x80,
            0x14, 0x8e, 0xbb, 0x9f, 0xd7, 0xf4, 0x0c, 0xdb, 0xa4, 0xcb, 0xfa, 0xf1, 0x25, 0x23,
            0x2c, 0x0e, 0xbd, 0xf6,
        ],
    ),
    (
        "island",
        [
            0x69, 0x70, 0xcf, 0xec, 0x66, 0x16, 0xdc, 0x6f, 0x49, 0x2d, 0xd9, 0xaa, 0x59, 0x98,
            0xff, 0x53, 0x73, 0xae, 0x9b, 0x94, 0xb5, 0xe4, 0x8d, 0x79, 0x6c, 0xab, 0xa1, 0x30,
            0x16, 0xfa, 0x4f, 0x96,
        ],
    ),
    (
        "island-lossy",
        [
            0x2f, 0x64, 0x77, 0xbd, 0x1e, 0xb4, 0x1f, 0x85, 0xfd, 0xa2, 0xbe, 0x39, 0x07, 0x75,
            0x17, 0xdb, 0x2a, 0xde, 0x7c, 0x61, 0xad, 0x6a, 0x6e, 0x78, 0x37, 0xac, 0xa0, 0x45,
            0x2e, 0xce, 0x0f, 0xf9,
        ],
    ),
];
