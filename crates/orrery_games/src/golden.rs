...
/// Regolith, by scenario name. Generated with the command above at ruleset v3.
pub const REGOLITH: [(&str, [u8; 32]); 4] = [
    (
        "solo",
        [
            0x41, 0x6f, 0xa4, 0xad, 0x48, 0xb8, 0xb2, 0x6a, 0xda, 0x7a, 0xe5, 0xb1, 0xa7, 0xbf,
            0x11, 0x10, 0x0d, 0xff, 0x59, 0xd5, 0x96, 0xc8, 0x4a, 0xea, 0x34, 0x72, 0x45, 0x89,
            0x32, 0x33, 0x71, 0xbe,
        ],
    ),
    (
        "duel",
        [
            0x90, 0x82, 0x2f, 0xba, 0xb8, 0x55, 0x73, 0xa4, 0x4d, 0x7e, 0x6b, 0x78, 0x78, 0xba,
            0xc8, 0xde, 0xb4, 0xd6, 0xe9, 0x78, 0x1f, 0x99, 0x08, 0xd6, 0xaa, 0xa8, 0x9e, 0x0f,
            0xf1, 0xb8, 0xda, 0xe6,
        ],
    ),
    (
        "island",
        [
            0x48, 0xb2, 0x08, 0xec, 0xc5, 0xc3, 0xaa, 0x89, 0x1d, 0x2d, 0xb2, 0xfc, 0xee, 0x3a,
            0xff, 0xc0, 0xe0, 0xfc, 0x32, 0x25, 0xe5, 0x07, 0x02, 0xd4, 0xbf, 0x7d, 0x48, 0x90,
            0x35, 0xf5, 0x73, 0x25,
        ],
    ),
    (
        "island-lossy",
        [
            0x24, 0x4d, 0x7a, 0x1d, 0x12, 0x77, 0x18, 0x79, 0x48, 0xd8, 0xb8, 0xb7, 0x67, 0x8b,
            0xd4, 0x3b, 0x6d, 0x20, 0xa2, 0xc0, 0x2e, 0x26, 0x06, 0x4e, 0x2d, 0xb4, 0xb9, 0x83,
            0xed, 0xc4, 0x02, 0x17,
        ],
    ),
];
...
pub const REGOLITH_PICKUP_CONTEST: [[u8; 32]; 3] = [
    [
        0x50, 0x63, 0xcf, 0x10, 0xbd, 0x93, 0x89, 0x91, 0x5b, 0x92, 0x1d, 0x75, 0x91, 0x60, 0x51,
        0x7f, 0x2d, 0x41, 0x53, 0x81, 0x8a, 0xdb, 0x67, 0x0d, 0x71, 0x8c, 0x5e, 0xab, 0x53, 0x60,
        0x93, 0xff,
    ],
    [
        0x67, 0xaf, 0xc3, 0x23, 0xe9, 0x4e, 0x76, 0x82, 0x23, 0x4e, 0xb1, 0xb7, 0x3b, 0x9c, 0x71,
        0xd7, 0x89, 0x67, 0x9b, 0x02, 0x45, 0x8f, 0x03, 0x4b, 0xd4, 0xf4, 0x20, 0x32, 0x67, 0x9c,
        0x5d, 0xe8,
    ],
    [
