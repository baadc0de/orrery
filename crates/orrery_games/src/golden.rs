...
/// Regolith, by scenario name. Generated with the command above at ruleset v4.
pub const REGOLITH: [(&str, [u8; 32]); 4] = [
    (
        "solo",
        [
            0x2e, 0xfc, 0xed, 0x1d, 0x82, 0x40, 0x3f, 0x79, 0xa3, 0xbf, 0xc7, 0x97, 0xd9, 0x5d,
            0x53, 0xf8, 0x94, 0x84, 0xf8, 0xcb, 0x53, 0xed, 0xf6, 0x5b, 0xc0, 0x65, 0x87, 0x4c,
            0x86, 0xc1, 0x5f, 0x93,
        ],
    ),
    (
        "duel",
        [
            0x4e, 0x72, 0xdd, 0x07, 0x98, 0xf2, 0x40, 0xcd, 0x56, 0x83, 0x35, 0x62, 0x5c, 0xae,
            0xc5, 0x88, 0x71, 0xc1, 0xbd, 0xbd, 0xf7, 0x9c, 0x3e, 0x60, 0x8c, 0xe2, 0xe4, 0xc0,
            0x28, 0x27, 0x2f, 0xd4,
        ],
    ),
    (
        "island",
        [
            0xc2, 0x9c, 0x1e, 0xe3, 0x0d, 0xa5, 0x4a, 0xfe, 0xc2, 0x18, 0xbb, 0xae, 0x48, 0x6e,
            0xce, 0x7e, 0x0f, 0x3d, 0x8a, 0x7e, 0x2f, 0x06, 0xc3, 0x3b, 0x2a, 0x16, 0xe8, 0x4f,
            0x0a, 0xd7, 0xe4, 0x50,
        ],
    ),
    (
        "island-lossy",
        [
            0x60, 0xe9, 0x9e, 0x0c, 0xb2, 0x2d, 0xe8, 0xf9, 0x5d, 0x70, 0xfe, 0x9d, 0x17, 0xb4,
            0x46, 0x60, 0x52, 0xde, 0xb4, 0x5b, 0x26, 0x7b, 0xb0, 0x28, 0x2d, 0xda, 0x48, 0x59,
            0x07, 0x21, 0x6d, 0x6d,
        ],
    ),
];
