...
The figures above are one link in isolation. `gates/p1-swarm --witness` is the
...
Read it as an effect rather than as a clean A/B, though — `gates/p1-swarm`'s router
