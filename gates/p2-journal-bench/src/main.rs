...
//!
//! ```sh
//! gates/p2-journal-bench --store fjall   --dir /mnt/nvme/bench --seconds 60
//! gates/p2-journal-bench --store rocksdb --dir /mnt/nvme/bench --seconds 60   # needs --features rocksdb-store
//! ```
//!
...
fn main() {
    let args = match parse_args() {
        ...
        Err(e) => {
            ...
            eprintln!(
                "usage: gates/p2-journal-bench --store fjall|rocksdb|wal-db --dir DIR \
    ...
    println!("== gates/p2-journal-bench: {store_name} ==");
    println!(
