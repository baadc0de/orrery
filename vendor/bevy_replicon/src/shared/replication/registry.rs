...
impl FnsId {
    ...
    ///
    /// Orrery addition: lets downstream consumers construct a [`FnsId`] (e.g.
    /// to build `ComponentDiff` in tests) without going through a live registry.
    #[must_use]
    pub const fn new(index: usize) -> Self {
        Self(index)
    }

    /// The raw index of this rule id.
    #[must_use]
