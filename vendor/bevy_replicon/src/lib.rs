...
#![no_std]
// Orrery vendoring: the workspace enables `missing_docs`, but upstream replicon
// doesn't document every item. Allow it so vendoring doesn't surface ~72
// warnings from unmodified upstream code.
#![allow(missing_docs)]
