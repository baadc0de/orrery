...
**Result:** 191,640 → **24,842 tris**, symmetric, textured, 13 MB GLB with the two 2k PNGs. Symmetrize mirrors decals too (the hull number now reads on both flanks), so in the real pipeline decals are placed *after* symmetry, as a separate layer (G12.11 procurement: decals are inputs).
