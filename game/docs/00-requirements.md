...
- **Research spikes handed to the Orrery planning session on 2026-09-04**, each to produce a number or artifact: (1) Rust static library with headless Bevy inside an Unreal 5.8 process, predicted-tick latency comparable to #920; (2) one-body cook with Unreal-versus-ruleset ray agreement, fixing the collision representation; (3) moving interiors in Unreal with per-grid local frames and seamless boarding and undocking; (4) season package size and cook time extrapolated to dozens of bodies. Spikes 1–3 together are accepted by the first slice (G11).
