...
- **G10.2's in-process choice is not yet measured.** The sidecar IPC threshold (#920) was defined for Windows at N=24 and the only artifacts are Linux; the report script refuses a verdict off-platform. One nightly Windows run turns the choice from judgement into evidence and should precede acceptance of the Orrery amendments (D52, D53).
