...
- **Ships are respawn points.** The clonable-crew loop (G6.5) means a ship carries clone capacity: a mission member who dies respawns aboard, paying clone upkeep (G3.1) and dropping loot at the death site (G3.2). Respawn location is therefore the ship's grid while on mission and the mothership otherwise. Whether ship clone capacity is finite per mission (a "tickets" budget) is a G8 balance decision.
