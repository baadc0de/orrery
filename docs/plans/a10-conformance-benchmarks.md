...
| F-4 | Legacy-vs-candidate differential harness, four artifact classes (§4) | `orrery_conformance` + a standalone runner | `differential::{state,outcome,persistence,witness}_parity` per module | **landed** — not as planned: `crates/orrery_games/src/diff.rs`, all four §4.1 classes (#748/#749, generalized across substrates at #757) |
