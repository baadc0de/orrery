...
Normative source: [DECISIONS.md](DECISIONS.md) **D8** (expanding on D2, D6, D7; touching D9/D10 for the witness signal and D11 for durable consequences). All defaults below are the D16 parameter table; games may reconfigure them (§12).
