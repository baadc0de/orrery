...
- **Drain:** last peer leaves → authority leases are released or expire (D7), cell actors checkpoint and quiesce (D11), cells are **parked**: no live authority, state served from the hot tier, optional catch-up simulation on next load.
